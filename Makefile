...
#    Updated: 2018/11/24 14:31:27 by cde-moul         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
RCS =	ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
	ft_memchr.o ft_memcmp.o ft_strlen.o ft_strdup.o ft_strcpy.o \
	ft_strncpy.o ft_strcat.o ft_strncat.o ft_strlcat.o ft_strstr.o \
	ft_strrchr.o ft_strchr.o ft_strnstr.o ft_strcmp.o ft_strncmp.o ft_atoi.o \
	ft_isalpha.o ft_isdigit.o ft_isalnum.o ft_isascii.o ft_isprint.o \
	ft_isascii.o  ft_isprint.o ft_toupper.o ft_tolower.o ft_memset.o \
	...
	ft_lstmap.o ft_print_alphabet.o ft_reverse_alphabet.o ft_div_mod.o \
	ft_div.o ft_mod.o ft_putnbr_base.o ft_lstappend.o ft_lstsize.o \
	ft_fibonacci.o ft_recursive_factorial.o ft_recursive_power.o
